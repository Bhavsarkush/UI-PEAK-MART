...
import 'package:pmartui/Account/Saved%20address.dart';
import 'package:pmartui/Address.dart';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

import '../BottomNavigationBar/Checkout.dart';
...
class ProductDetails extends StatefulWidget {
  ...
  const ProductDetails({
    ...
    required this.product,
     // Add cartItems to the constructor
  }) : super(key: key);
...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Future<void> _addToCart(ProductModel product) async {
    ...
    try {
      ...
      // Add the selected product to the _cartItems list
