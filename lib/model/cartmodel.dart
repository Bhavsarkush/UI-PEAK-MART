...
class CartModel {
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'productDetail1': product1,
      'productDetail2': product2,
      'productDetail3': product3,
      'productDetail4': product4,
      'productTitle1': title1,
      'productTitle2': title2,
      'productTitle3': title3,
      'productTitle4': title4,
      'discount': discount,
      'newPrice': newPrice,
