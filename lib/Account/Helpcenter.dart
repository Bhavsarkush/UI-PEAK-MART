  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Need Help',style: TextStyle(fontWeight: FontWeight.bold),),
        centerTitle: true,
      ),
        ...
        child: Column(
          ...
          children: [
            ...
            ContactItem(
              icon: Icons.email,
              title: 'Email',
              subtitle: 'mailto:support@shopperstore.com',
              onTap: () {
                mailto:launchEmail('support@shopperstore.com');
              },
            ),
            ContactItem(
              icon: Icons.phone,
            ...
            ContactItem(
              ...
              mapQuery: 'Indus+University,+Ahmedabad,+Gujarat',
              onTap: () {
