          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                // Display message when the order is cancelled by the user
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text(
        ...
        builder: (context, snapshot) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              var products = orderData['Items'] as List<
                  dynamic>; // Assuming 'Items' field contains the list of products
              var amount =
                  orderData['Amount']; // Fetching total amount directly
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontWeight: FontWeight.bold,
                            color: deliveryStatus == 'Cancelled'
                                ? Colors.red
                                : Colors.orange,
                          ),
                        ),
